...
export default function Footer() {
  return (
    <footer className="relative mt-20 bg-gradient-to-br from-gray-900 via-gray-950 to-black text-gray-300 border-t border-gray-800 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[400px] h-[200px] bg-blue-500/20 blur-[120px] rounded-full"></div>
...
function SocialIcon({
  ...
  return (
    ...
    >
      <div
        className={`absolute inset-0 bg-blue-500/10 opacity-0 group-hover:opacity-100 rounded-full blur-md transition duration-300`}
      ></div>
